...
public class TodoService {
	...
	public Page<TodoResponses> getTodoResponses(int page, int size, String title, String nickname, LocalDate startDate,
		LocalDate endDate) {
		...
		return todoRepository.searchSchedules(title, startDateTime, endDateTime, nickname,
			pageable);
	}
}
